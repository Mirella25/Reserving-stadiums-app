...
abstract class AppLocalizations {
  ...
  /// No description provided for @newToLogistics.
  ///
  /// In en, this message translates to:
  /// **'New to logistics? '**
  String get newToLogistics;
  ...
  /// No description provided for @joinedBefore.
  ///
  /// In en, this message translates to:
  /// **'Joined us before?'**
