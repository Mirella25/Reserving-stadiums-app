...
abstract class $FacilityModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, List<String>? photos});
}
...
class _$FacilityModelImpl implements _FacilityModel {
  const _$FacilityModelImpl(
      {required this.id, required this.name, final List<String>? photos})
      : _photos = photos;
  ...
  @override
  String toString() {
    return 'FacilityModel(id: $id, name: $name, photos: $photos)';
  }
...
abstract class _FacilityModel implements FacilityModel {
  const factory _FacilityModel(
      ...
      final List<String>? photos}) = _$FacilityModelImpl;
