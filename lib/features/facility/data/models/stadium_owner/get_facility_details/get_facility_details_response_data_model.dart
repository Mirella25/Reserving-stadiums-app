...
part 'get_facility_details_response_data_model.freezed.dart';
part 'get_facility_details_response_data_model.g.dart';
...
@freezed
class GetFacilityDetailsResponseDataModel
    with _$GetFacilityDetailsResponseDataModel {
  const factory GetFacilityDetailsResponseDataModel({
    int? id,
  ...
  }) = _GetFacilityDetailsResponseDataModel;
  factory GetFacilityDetailsResponseDataModel.fromJson(
          Map<String, dynamic> json) =>
      _$GetFacilityDetailsResponseDataModelFromJson(json);
}

extension GetFacilityDetailsResponseDataModelX
    on GetFacilityDetailsResponseDataModel {
