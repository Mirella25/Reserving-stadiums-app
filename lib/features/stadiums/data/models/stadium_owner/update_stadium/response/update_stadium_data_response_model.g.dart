...
_$UpdateStadiumDataResponseModelImpl
    _$$UpdateStadiumDataResponseModelImplFromJson(Map<String, dynamic> json) =>
        _$UpdateStadiumDataResponseModelImpl(
...
Map<String, dynamic> _$$UpdateStadiumDataResponseModelImplToJson(
        _$UpdateStadiumDataResponseModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
